...
- June 25, 2025. Fixed .bduyur form error and syntax issues:
  ...
  - Simplified trade command first modal to only 2 fields: "Ek Miktar" and "İstenen Oyuncu"
  - Removed "Sözleşme+Ek Madde" field from trade president negotiation phase as requested
